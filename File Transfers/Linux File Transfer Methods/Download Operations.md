...
```shell-session
pepedavidphone@htb[/htb]$ md5sum id_rsa
...
```shell-session
pepedavidphone@htb[/htb]$ cat id_rsa |base64 -w 0;echo
...
```shell-session
pepedavidphone@htb[/htb]$ wget https://raw.githubusercontent.com/rebootuser/LinEnum/master/LinEnum.sh -O /tmp/LinEnum.sh
```
...
```shell-session
pepedavidphone@htb[/htb]$ curl -o /tmp/LinEnum.sh https://raw.githubusercontent.com/rebootuser/LinEnum/master/LinEnum.sh
```
